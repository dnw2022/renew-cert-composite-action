...
then
  ...
  gh secret set $CERT_THUMBPRINT_SECRET_NAME --org $ORGANIZATION --visibility all --body "$FINGER_PRINT" 
  gh secret set $CERT_SECRET_NAME --org $ORGANIZATION --visibility all < cert.base64
